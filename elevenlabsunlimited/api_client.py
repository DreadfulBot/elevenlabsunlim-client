...
from elevenlabsunlimited.configuration import Configuration
from elevenlabsunlimited.api_response import ApiResponse, T as ApiResponseT
import elevenlabsunlimited.models
from elevenlabsunlimited import rest
from elevenlabsunlimited.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(elevenlabsunlimited.models, klass)
