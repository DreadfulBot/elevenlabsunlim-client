...
class DefaultApi:
    ...
    @validate_call
    def download_audio_api_v1_voice_download_task_id_get(
        self,
        task_id: StrictStr,
        ...
        _param = self._download_audio_api_v1_voice_download_task_id_get_serialize(
            task_id=task_id,
    ...
    @validate_call
    def download_audio_api_v1_voice_download_task_id_get_with_http_info(
        self,
        task_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def download_audio_api_v1_voice_download_task_id_get_without_preload_content(
        self,
        task_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _download_audio_api_v1_voice_download_task_id_get_serialize(
        self,
        task_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_user_stats_api_v1_user_stats_get(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_user_stats_api_v1_user_stats_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_user_stats_api_v1_user_stats_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_user_stats_api_v1_user_stats_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_user_stats_api_v1_user_stats_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/user/stats',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
